      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          border: Border(
            bottom: BorderSide(
              width: 1.0,
              color: isLeft?Colors.lightBlue:Colors.black12
            )
          )
        ),
        child: Text(
          '详细',
          style: TextStyle(
            color:isLeft?Colors.lightBlue:Colors.black
          ),
        ),
      ),
    );
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          border: Border(
            bottom: BorderSide(
              width: 1.0,
              color: isRight?Colors.lightBlue:Colors.black12
            )
          )
        ),
        child: Text(
          '评论',
          style: TextStyle(
            color:isRight?Colors.lightBlue:Colors.black
          ),
        ),
      ),
    );
